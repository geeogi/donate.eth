...
////////CHECK IF WEB3////// This bit of code checks to see what sort of web3 the user has, if any... 
...
} else { // Else, if there's no web3, ask user to get web3 (Iphone/android/desktop users each get a different message)
...
//////////SEND TRANSACTION/////// This function generates the web3 transaction...            
...
//////////////////////////Donation Count//////////// This function updates the donation counter... 
...
function GetCount(theURL) {
    ...
    var charity = "0xF30B6Efd7B77Ad91C2a9D12fdb4dfE38dbc506f8";
    var url =  theURL + "api?module=account&action=balance&address=" + charity + "&tag=latest&apikey=YOUR-API-KEY-GOES-HERE"; //sign up to etherscan.io to get an API key. 
...
////////utility functions//////// These smaller functions are used by the other functions... 
